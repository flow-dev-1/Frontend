    ...
    return (
        <div className='success-modal modal-content'>
            <div className="d-flex flex-column align-items-center">
                ...
                {from === "otp" ? (
                    <button onClick={() => { navigate('/school/sign-in') }} className="btn submit-btn mt-5">Proceed to Sign In</button>
                ) : from === "resetPassword" ? (
                    <button onClick={() => { navigate('/school/sign-in') }} className="btn submit-btn mt-5">Sign In</button>
                ) : null}
