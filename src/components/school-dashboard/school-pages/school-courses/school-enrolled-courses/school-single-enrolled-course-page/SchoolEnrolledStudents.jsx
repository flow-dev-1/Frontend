    ...
    <div className="enrolled-course-student">
      ...
      <div className="info-bar">
        ...
        <div className="info-item">
          ...
          <p>
            {" "}
            {new Date(enrollmentData.createdAt).getUTCDate()} -{" "}
            {new Date(enrollmentData.createdAt).getUTCMonth() + 1} -{" "}
        ...
        <div className="info-item">
          <p className="info-p">No. of Students:</p>
