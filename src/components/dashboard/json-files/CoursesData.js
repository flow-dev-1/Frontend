...
const courses = [
  {
    ...
    objectives: [
      {
        title: 'Max the Explorer Monkey',
        subtitle: 'Understanding the Growth Mindset',
        description:
    ...
    objectives: [
      {
        title: '',
        description:
          'Understand the concept of personal values and identify their own core values that guide their actions and decisions',
      },
      {
        title: '',
        description:
          'Develop a deeper understanding of their aspirations and desires, and how they relate to their core values.',
      },
      {
        title: '',
        description:
          'Set specific, measurable, achievable, relevant, and time-bound (SMART) goals that align with their personal values and aspirations.',
      },
      {
        title: '',
        description:
          'Create actionable plans to achieve their goals, taking into consideration the potential helps and hurdles they may encounter.',
      },
      {
        title: '',
        description:
          'Develop resilience and adaptability in overcoming obstacles and setbacks while working towards their goals.',
      },
      {
        title: '',
        description:
          'Reflect on their progress and growth throughout the course, recognizing the importance of self-awareness and self-improvement in the pursuit of personal success.',
      },
      {
        title: 'By the end of the FLOW Club',
        description:
          'Values and Goals program, students will have a clear understanding of their personal values and aspirations and be well-equipped with the necessary tools and strategies to set and achieve meaningful goals, fostering a strong foundation for personal growth and success.',
      },
    ],
    enrolled: false,
  },
