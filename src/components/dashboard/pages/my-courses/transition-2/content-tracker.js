...
export const transition2ContentTracker = [
  ...
  {
    id: "transition-2-week-4-page-2-step-1-freedom-regret",
    type: CONTENT_TYPES.step,
    week: 4,
    page: 2,
    step: 1,
    ...
    notes:
      "Converted Week 4 Page 2 into a two-step text activity; existing question is now Step 2.",
  },
  {
    id: "transition-2-week-4-page-8-week-reflection",
    type: CONTENT_TYPES.page,
    week: 4,
    page: 8,
    ...
    feedbackPath: "./feedback/weeks/week4/Week4.jsx",
    notes:
      "Inserted text response page; video inserted as Page 9 and old Week 4 Page 8 shifted to Page 10.",
  },
  {
    id: "transition-2-week-4-page-9-video-insert",
    type: CONTENT_TYPES.page,
    week: 4,
    page: 9,
    ...
    feedbackPath: null,
    notes:
      "Inserted video after the new Week 4 Page 8 week reflection question.",
  },
  {
    id: "transition-2-week-4-page-12-step-2-social-skill-rating",
    type: CONTENT_TYPES.step,
    week: 4,
    page: 12,
    step: 2,
  ...
  {
    id: "transition-2-week-4-page-14-exam-choice",
    type: CONTENT_TYPES.page,
    week: 4,
    page: 14,
  ...
  {
    id: "transition-2-week-4-page-15-video-insert",
    type: CONTENT_TYPES.page,
    week: 4,
    page: 15,
  ...
  {
    id: "transition-2-week-4-page-18-james-outcome-choice",
    type: CONTENT_TYPES.page,
    week: 4,
    page: 18,
    name: "WeekFourPage18JamesOutcomeChoice",
    path: "./weeks/week4/page14-exam-choice/Page14.jsx",
    feedbackStatus: FEEDBACK_STATUS.complete,
    feedbackPath: "./feedback/weeks/week4/Week4.jsx",
    notes:
      "Inserted multiple-choice James outcome question; video inserted as Page 19 and old Week 4 Page 18 shifted to Page 20.",
  },
  {
    id: "transition-2-week-4-page-19-video-insert",
    type: CONTENT_TYPES.page,
    week: 4,
    page: 19,
    ...
    feedbackPath: null,
    notes:
      "Inserted video after the new Week 4 Page 18 James outcome question.",
  },
  /*
