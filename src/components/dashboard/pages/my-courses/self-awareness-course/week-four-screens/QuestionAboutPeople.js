...
export default function QuestionAboutPeople({ onSubmit, onBack }) {
  const [currentIndex, setCurrentIndex] = useState(1)
  const [answers, setAnswers] = useState([
    { q1: '', q2: '', q3: '' }, // For question 1
    { q1: '', q2: '', q3: '' }, // For question 2
    { q1: '', q2: '', q3: '' }, // For question 3
  ])
  ...
  const handleInputChange = (e, index) => {
    ...
    setAnswers((prevAnswers) => {
      ...
      updatedAnswers[currentIndex - 1][name] = value
      return updatedAnswers
    })
  }

  // Validate if all answers for the current question are filled
              ...
              <div className='mt-2'>
                <div className='question-box-header align-items-start'>
                  ...
                  <h2 className='mb-0 d-flex ms-3 text-left'>
                    ...
                    what would you like to change? If yes, type “YES” in the
                    box.
                  </h2>
                </div>
                <div className='text-area-box px-4 mt-1'>
