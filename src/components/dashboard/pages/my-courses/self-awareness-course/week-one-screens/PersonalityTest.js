...
export default function PersonalityTest({ onNext, onBack, formData, activityIndex }) {
	const answers = [
		...
		{
			title: 'You find yourself in a leadership position during a team meeting. What is your main focus?',
			questionList: [
		...
		{
			title: 'When faced with a new and challenging problem, what is your approach?',
			questionList: [
		...
		{
			title: 'Teachers at school (who like me and in whose class I do pretty well) would probably describe me as:',
			questionList: [
		...
		{
			title: 'Teachers at school who saw me when I wasn’t on my best behavior might describe me as:',
			questionList: [
	...
	return (
		<div>
			...
			<div className="progression-btns mt-3">
				<button className="btn prev light" onClick={handleBackClick}>
					{'<<< Back'}
				</button>
